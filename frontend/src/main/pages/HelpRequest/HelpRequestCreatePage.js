...
export default function HelpRequestCreatePage({storybook=false}) {
    ...
    const onSuccess = (helpRequest) => {
        toast(`New Help Request Created - id: ${helpRequest.id} requesterEmail: ${helpRequest.requesterEmail} teamId: ${helpRequest.teamId} tableOrBreakoutRoom: ${helpRequest.tableOrBreakoutRoom} explanation: ${helpRequest.explanation} requestTime: ${helpRequest.requestTime} solved: ${helpRequest.solved}`);
    }
